...
import { type ActionResult, type AnyAuth, type Connection, type ConnectionOptions, type LiveQueryResponse, type MapQueryResult, type Patch, type RawQueryResult, type Result, type ScopeAuth, type Token } from "../types.js";
export declare class WebSocketStrategy implements Connection {
     ...
     */
    info<T extends Record<string, unknown> = Record<string, unknown>>(): Promise<ActionResult<T> | undefined>;
    /**
